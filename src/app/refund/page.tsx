  ...
  return (
    <div className="bg-warm min-h-screen">
      <div className="mx-auto max-w-3xl px-4 sm:px-6 lg:px-8 py-16">
        <h1 className="font-heading text-3xl sm:text-4xl font-bold text-graphite mb-8">Refund Policy</h1>
        <div className="prose prose-lg max-w-none text-graphite/80 space-y-8">
          <section>
            <h2 className="font-heading text-xl font-bold text-graphite">1. Returns</h2>
            <p>We accept returns within 30 days of the date received. Products must be unopened and in original packaging.</p>
          </section>
          <section>
            <h2 className="font-heading text-xl font-bold text-graphite">2. Refund Process</h2>
          ...
          <section>
            <h2 className="font-heading text-xl font-bold text-graphite">3. Return Shipping</h2>
          ...
          <section>
            <h2 className="font-heading text-xl font-bold text-graphite">6. Refund Method</h2>
            <p>Refunds are issued to the original payment method used at checkout.</p>
          </section>
          <section>
            <h2 className="font-heading text-xl font-bold text-graphite">7. Exchanges</h2>
