    ...
    <div className="bg-cream min-h-screen">
      <div className="mx-auto max-w-3xl px-4 sm:px-6 lg:px-8 py-16">
        ...
        <div className="prose prose-lg max-w-none text-espresso/80 space-y-8">
          ...
          <section>
            <h2 className="font-heading text-xl font-bold text-espresso">11. Changes to This Policy</h2>
            <p>We may update this policy from time to time. Changes will be posted on this page.</p>
          </section>
          <section>
            <h2 className="font-heading text-xl font-bold text-espresso">12. Contact</h2>
