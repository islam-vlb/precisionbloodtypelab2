...
export const FALLBACK_PRODUCTS: Product[] = [
  {
    ...
    variants: [
      ...
      },
      {
        ...
        label: '1 Scale + 1 Resistance Band Fitness Set — Starter',
        detail: '1 Scale + Resistance Band Fitness Set',
        price: 49.76,
        section: 'Scale + Support Bundle Offers',
        isBundle: true,
        scaleCount: 1,
        image: '/images/products/scale-1x-bands-combo.jpg',
      },
      {
        id: 'tk-bundle-supp-60',
        label: '1 Scale + 1 Resistance Band Fitness Set — Standard',
        detail: '1 Scale + Resistance Band Fitness Set',
        price: 53.45,
        section: 'Scale + Support Bundle Offers',
        isBundle: true,
      ...
      },
      {
        ...
        label: '1 Scale + 1 Resistance Band Fitness Set — Extended',
        detail: '1 Scale + Resistance Band Fitness Set',
        price: 54.95,
        section: 'Scale + Support Bundle Offers',
        isBundle: true,
      ...
      },
      {
        ...
        label: '2-Scale + Resistance Band Bundle — includes 2 Scales + 1 Fitness Set (Starter)',
        detail: '2 Scales + Resistance Band Fitness Set',
        price: 87.64,
        section: 'Multi-Scale Bundle Offers',
        isBundle: true,
        scaleCount: 2,
        image: '/images/products/scale-2x-bands-combo.jpg',
      },
      {
        id: 'tk-multi-2-supp-60',
        label: '2-Scale + Resistance Band Bundle — includes 2 Scales + 1 Fitness Set (Standard)',
        detail: '2 Scales + Resistance Band Fitness Set',
        price: 87.76,
        section: 'Multi-Scale Bundle Offers',
        isBundle: true,
      ...
      },
      {
        ...
        label: '2-Scale + Resistance Band Bundle — includes 2 Scales + 1 Fitness Set (Extended)',
        detail: '2 Scales + Resistance Band Fitness Set',
        price: 94.82,
        section: 'Multi-Scale Bundle Offers',
        isBundle: true,
